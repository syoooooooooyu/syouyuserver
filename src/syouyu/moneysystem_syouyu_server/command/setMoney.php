...
class setMoney extends \pocketmine\command\Command{

	public function __construct(string $name = "setmoney", Translatable|string $description = "お金をセットする", Translatable|string|null $usageMessage = null, array $aliases = []){
	...
	public function execute(CommandSender $sender, string $commandLabel, array $args){
		...
		if(isset($args[0], $args[1])){
			...
			MoneySystemAPI::getInstance()->setMoney($player, (int)$args[1]);
